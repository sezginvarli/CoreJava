...
public class Fp02 {
    ...
    */
    ...
    //6) Create a method to calculate the product of the cubes of distinct even elements. (Functional with method reference)
    ...
    //    greater than 5 in reverse order in the list. (Functional with method reference)
